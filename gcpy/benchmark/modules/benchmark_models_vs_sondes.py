...
def main():
    ...
    ref_label = '14.2.0-rc.2'
    dev_label = '14.3.0-rc.0'

    # Observation file paths
    obs_root_dir = "/n/jacob_lab/Lab/obs_data_for_bmk/atom_obs/"
    obs_data_file = f"{obs_root_dir}/allozonesondes_2010-2019.csv"
    obs_site_file = f"{obs_root_dir}/allozonesondes_elevation.csv"

    # Model file paths
    model_root_dir = "/n/holyscratch01/jacob_lab/ryantosca/BM/1yr"
    suffix = "GCClassic/FullChem/OutputDir/GEOSChem.SpeciesConc*2019*.nc4"
    ref_filepaths = f"{model_root_dir}/{ref_label}/{suffix}"
    dev_filepaths = f"{model_root_dir}/{dev_label}/{suffix}"

    # PDF output folder
    dst = "/n/holyscratch01/jacob_lab/ryantosca/BM/1yr/BenchmarkResults/GCC_version_comparison/ModelVsObs"
